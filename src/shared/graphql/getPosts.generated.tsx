...
export type GetAllPostsQuery = { __typename?: 'Query', getPosts: { __typename?: 'PostsPaginationModel', totalCount: number, pageSize: number, pagesCount: number, items: Array<{ __typename?: 'Post', description: string, createdAt: string, id: number, postOwner: { __typename?: 'PostOwnerModel', id: number, userName: string, avatars?: Array<{ __typename?: 'Avatar', url?: string | null }> | null }, images?: Array<{ __typename?: 'ImagePost', url?: string | null }> | null, userBan?: { __typename?: 'UserBan', reason: string } | null }> } };
